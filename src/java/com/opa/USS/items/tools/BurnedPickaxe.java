...
public class BurnedPickaxe extends ItemPickaxe{
    public BurnedPickaxe(ToolMaterial material) {
        super(material);
        this.setUnlocalizedName(Reference.BurnedPickaxe);
